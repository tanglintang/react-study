...
export default class extends Component {
  constructor (props) {
    super (props)
    // 将路由重定向至 '/home'
    // http://www.baidu.com/product/:id?a=1&b=2
    // 'product/:id' 就是路径
    ...
    return (
      <div className={ styles.home }>
        ...
        <StickyContainer>
          ...
          <ListView dataSource={this.dataSource} renderFooter={() => (
            <div style={{ padding: 30, textAlign: 'center' }}>
              { this.state.isLoading ? '加载中...' : '暂无更多' }
            </div>
            )}
            renderRow={this.renderRow} pageSize={4} useBodyScroll scorllRenderAheadDistance={500} onEndReached={this.onEndReached} onEndReachedThreshold={10}
          />
        </StickyContainer>
      </div>
    )
